...
%>
	...
	<ul class="pagination justify-ccontent-center mt-3">
		<li class="page-item">
<%
	if(pageNumber <=0) {
%>		
...
%>
	...
	<!-- 특정한 url을 이동하는경우 url인코더를 이용하는게 일반적 -->
 	<!--  여러개의 페이지가있는 하나의 구성요소를 작업할때 사용 -->
<%
	}
%>
	</li>
...
%>
	...
	<!-- 특정한 url을 이동하는경우 url인코더를 이용하는게 일반적 --> <!--  여러개의 페이지가있는 하나의 구성요소를 작업할때 사용 -->
<%
	}
%>
	</li>
